...
import 'package:flutter_e2e/src/e2e/sodium_x_chacha20_poly1305_ietf_e2e_cryptography.dart';
...
void main() {
  ...
  setUp(() {
    ...
    serverE2eCryptography =
        SodiumXChaCha20Poly1305IetfE2eCryptography(serverE2eSharedKey);
    clientE2eCryptography =
        SodiumXChaCha20Poly1305IetfE2eCryptography(clientE2eSharedKey);
  });
