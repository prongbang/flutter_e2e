...
void main() {
  ...
  setUp(() {
    ...
    serverE2eCryptography = SodiumChaCha20Poly1305IetfE2eCryptography(serverE2eSharedKey);
    clientE2eCryptography = SodiumChaCha20Poly1305IetfE2eCryptography(clientE2eSharedKey);
  });
